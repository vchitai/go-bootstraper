// source: https://github.com/lyft/protoc-gen-star
package utils
...
// LowerDashNotation converts Name n to lower-dash-notation, where each part is
// lower-cased and concatenated with dash.
func (n Name) LowerDashNotation() Name { return n.Transform(strings.ToLower, strings.ToLower, "-") }
